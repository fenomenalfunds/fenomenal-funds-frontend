...
export async function fetchResourceDetail(token, slug, preview = {}) {
	...
	query fetchResourceDetail {
	  document: resourceArticles(where:{slug:"2020-organizational-resilience-and-learning-grant-call-for-applications-announcement-email-sent-to-prospera-network"}) {
	    title
	    subtitle
	    publish
	    image{
	  ...
	  related: resourceArticles(where:{slug_nin:"2020-organizational-resilience-and-learning-grant-call-for-applications-announcement-email-sent-to-prospera-network",publish_gte:"20210601"}){
	    title
	    subtitle
	    slug
	    thumbnail{
